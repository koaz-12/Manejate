...
export function TransactionActions({ id }: { id: string }) {
    ...
    return (
        <div className="flex flex-col gap-0.5 items-end pl-2 border-l border-slate-50 ml-2">
            ...
            <button onClick={handleDelete} disabled={loading} className="p-1.5 text-slate-300 hover:text-red-500 disabled:opacity-50 rounded-lg hover:bg-red-50 transition-colors">
