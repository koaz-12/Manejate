...
export function NotificationDropdown({ notifications, onMarkAllAsRead, onClose }: Props) {
    ...
    return (
        <div className="absolute top-full right-0 mt-3 w-80 sm:w-96 bg-white rounded-[1.5rem] shadow-2xl shadow-slate-200/50 border border-slate-100 z-50 animate-in fade-in zoom-in-95 duration-100 origin-top-right overflow-hidden flex flex-col max-h-[80vh]">
